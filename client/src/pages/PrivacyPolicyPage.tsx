...
const policy = {
  ar: {
    ...
    sections: [
      ...
      {
        title: "التخزين في المتصفح وملفات تعريف الارتباط",
      ...
      {
        title: "البيانات التقنية وحماية المعلومات",
        body: "قد تعالج البنية المستضيفة معلومات تقنية، مثل عنوان الإنترنت ونوع المتصفح ووقت الطلب، لتشغيل الخدمة وتشخيص الأعطال. تشمل وسائل الحماية في المنصة تشفير كلمات المرور والتحقق من تسجيل الدخول وصلاحيات المستخدمين. لا يمكن ضمان أمان مطلق لأي نظام؛ لذلك حافظ على سرية بيانات الدخول وتواصل معنا إذا اشتبهت في استخدام غير مصرح به لحسابك.",
      },
      {
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Hosting infrastructure may process technical information such as IP addresses, browser type, and request times to operate the service and diagnose issues. Platform safeguards include password hashing, authentication, and user permissions. No system can guarantee absolute security. Keep your login credentials private and contact us if you suspect unauthorized account access.",
      },
      {
