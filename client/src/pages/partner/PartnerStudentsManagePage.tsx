...
export const PartnerStudentsManagePage = () => {
  ...
  return (
    <div className="space-y-6">
                    ...
                    <td className="px-5 py-4">
                      <div className="flex flex-wrap gap-2">
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-2 rounded-full border border-rose-200 px-4 py-2 text-xs font-semibold text-rose-700 transition hover:bg-rose-50"
                        >
      ...
      <ConfirmationModal
        ...
        title={isArabic ? "تأكيد حذف الطالب" : "Confirm Student Deletion"}
        description={
          deleteTarget
            ? isArabic
              ? `سيتم حذف الطالب "${deleteTarget.name}" نهائيًا من حسابك.`
              : `This will permanently delete "${deleteTarget.name}" from your account.`
            : ""
        }
