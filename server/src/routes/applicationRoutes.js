...
const { listVisaCases, getVisaCase, updateVisaCase } = require('../controllers/visaCaseController');
router.use(protect);
...
router.get('/visa-cases', requireSection('visa'), listVisaCases);
router.get('/:id/visa-case', getVisaCase);
router.patch('/:id/visa-case', requireSection('visa'), updateVisaCase);
