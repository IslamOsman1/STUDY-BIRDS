    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute roles={["admin"]} />}>
        <Route element={<DashboardLayout />}>
          ...
          <Route path="/admin/mobile/manage/users" element={<AdminUsersPage />} />
          <Route path="/admin/mobile/manage/students" element={<AdminStudentsPage />} />
          <Route path="/admin/mobile/manage/students/:id" element={<AdminStudentsPage />} />
          <Route path="/admin/mobile/manage/student-documents" element={<AdminStudentDocumentsPage />} />
          <Route path="/admin/mobile/manage/student-notifications" element={<AdminStudentNotificationsPage />} />
          <Route path="/admin/mobile/manage/universities" element={<AdminUniversitiesPage />} />
          <Route path="/admin/mobile/manage/programs" element={<AdminProgramsPage />} />
          <Route path="/admin/mobile/manage/applications" element={<AdminApplicationsPage />} />
          <Route path="/admin/mobile/manage/content" element={<AdminContentPage />} />
          <Route path="/admin/mobile/manage/recognitions" element={<AdminRecognitionsPage />} />
          <Route path="/admin/mobile/manage/services" element={<AdminServicesPage />} />
          <Route path="/admin/mobile/manage/faqs" element={<AdminFaqsPage />} />
          <Route path="/admin/mobile/manage/testimonials" element={<AdminTestimonialsPage />} />
          <Route path="/admin/mobile/manage/site-settings" element={<AdminSiteSettingsPage />} />
          <Route path="/admin/mobile/manage/agency-requests" element={<AdminAgencyRequestsPage />} />
          <Route path="/admin/mobile/manage/agents" element={<AdminAgentsPage />} />
          <Route path="/admin/mobile/manage/agents/:id" element={<AdminAgentsPage />} />
          <Route path="/admin/mobile/manage/partner-students" element={<AdminPartnerStudentsPage />} />
          <Route path="/admin/mobile/manage/marketing-assets" element={<AdminMarketingAssetsPage />} />
          <Route path="/admin/mobile/manage/verification-queue" element={<AdminVerificationQueuePage />} />
          <Route path="/admin/mobile/manage/payout-requests" element={<AdminPayoutRequestsPage />} />
          <Route path="/admin/mobile/manage/support-tickets" element={<AdminSupportTicketsPage />} />
          <Route path="/admin/mobile/manage/knowledge-base" element={<AdminKnowledgeBasePage />} />
          <Route path="/admin/mobile/manage/student-financials" element={<AdminStudentFinancialsPage />} />
          <Route path="/admin/mobile/manage/student-arrivals" element={<AdminStudentArrivalRequestsPage />} />
          <Route path="/admin/mobile/manage/student-favorites" element={<AdminStudentFavoritesPage />} />
          <Route path="/admin/mobile/manage/student-orientation-results" element={<AdminStudentOrientationResultsPage />} />
          <Route path="/admin/mobile/manage/exhibitions" element={<AdminExhibitionsPage />} />
          <Route path="/admin/mobile/manage/events" element={<AdminEventsPage />} />
          <Route path="/admin/mobile/manage/our-story" element={<AdminOurStoryPage />} />
